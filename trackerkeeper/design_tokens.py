...
def _load_font_scale() -> float:
    ...
    same handle ``trackerkeeper.settings`` uses, and the reason the identity seam
...
# Host-OS window-corner radius. trackerkeeper's frameless surfaces (mini
...
def button_qss(tier: ButtonTier) -> str:
    ...
    """
    from trackerkeeper.theme import get_active_theme, ink_alpha
