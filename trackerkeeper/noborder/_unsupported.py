...
visible decoration from trackerkeeper's server-side-decorated main window. On Windows,
macOS, X11, and non-KDE Wayland (GNOME, Sway, …) trackerkeeper is either natively framed
