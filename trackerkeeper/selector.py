...
from trackerkeeper.design_tokens import TYPE_BODY, rad, type_qss
...
def selector_qss(host_selector: str = "") -> str:
    ...
    from trackerkeeper.ui_helpers import ACCENT, TEXT, TEXT_FAINT, ink_alpha
...
class Selector(QPushButton):
    ...
    def paintEvent(self, e):  # noqa: N802 — Qt naming
        ...
        super().paintEvent(e)
        from trackerkeeper.icons import _SVG
    ...
    def _add_list_widget(self, menu, cap_h: int) -> QListWidget:
        ...
        from trackerkeeper.theme import _hex_to_rgb
        from trackerkeeper.ui_helpers import (
            ACCENT,
            TEXT,
            ink_alpha,
        ...
        # honoured by trackerkeeper.smooth_scroll.SmoothScrollFilter.
        lw.setProperty("trackerkeeper_native_scroll", True)
