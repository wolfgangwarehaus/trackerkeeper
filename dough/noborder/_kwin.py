...
Why this exists: dough's main window is server-side-decorated on KDE Wayland
...
_DESCRIPTION = "dough — borderless frameless main window (managed)"
...
def _qsettings() -> QSettings:
    """The dough identity QSettings handle — the same
