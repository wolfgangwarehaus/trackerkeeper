...
— which never exercises the buggy path. dough ships a tiny KWin scripted
...
if is_kde_wayland():
    from dough.drag_repaint import _kwin as _backend
else:
    from dough.drag_repaint import _unsupported as _backend
